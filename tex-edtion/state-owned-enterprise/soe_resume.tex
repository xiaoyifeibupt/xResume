...
% set margin
\marginsize{2cm}{2cm}{1.1cm}{1.5cm}
% set page header
\headheight=25pt
...
\begin{document}
\noindent \textbf{\zihao{5} \heiti 求职目标}
\begin{itemize}
  \item \zihao{-5}软件研发工程师
\end{itemize}
\noindent \textbf{\zihao{5} \heiti 个人资料}\par
...
\end{tabular}\par
\noindent \textbf{\zihao{5} \heiti 教育背景}\par
...
\begin{itemize}
  ...
  \setlength{\parsep}{3pt}
  \setlength{\parskip}{3pt}
  \item \zihao{-5}2011-2012学年度校级三等奖学金
  \item \zihao{-5}2011-2012校级优秀学生干部
  \item \zihao{-5}2010-2011学年度校级三等奖学金
  \item \zihao{-5}2010-2011校级优秀学生干部
  \item \zihao{-5}担任学生会科技部部长期间获“优秀部长”称号
\end{itemize}
\noindent \textbf{\zihao{5} \heiti 个人能力}
\begin{itemize}
  \setlength{\itemsep}{0pt}
  \setlength{\parsep}{3pt}
  \setlength{\parskip}{3pt}
...
\end{itemize}
\noindent \textbf{\zihao{5} \heiti 实习经历}\\
...
\end{itemize}
\noindent \textbf{\zihao{5} \heiti 实验室项目}\\
...
\end{itemize}
\noindent \textbf{\zihao{5} \heiti 个人爱好}
\begin{itemize}
  \setlength{\itemsep}{0pt}
  \setlength{\parsep}{3pt}
  \setlength{\parskip}{3pt}
